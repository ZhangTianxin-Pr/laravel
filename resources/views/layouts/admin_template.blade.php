...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="bower_components/Ionicons/css/ionicons.min.css" type="text/css" media="all">
  <!-- Theme style -->
  <link rel="stylesheet" href="bower_components/admin-lte/dist/css/AdminLTE.min.css" type="text/css" media="all">
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect. -->
  <link rel="stylesheet" href="bower_components/admin-lte/dist/css/skins/skin-blue.min.css" type="text/css" media="all">
...
<!-- AdminLTE App -->
<script language="JavaScript" src="bower_components/admin-lte/dist/js/adminlte.min.js"></script>
